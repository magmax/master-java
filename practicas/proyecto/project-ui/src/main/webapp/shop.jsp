            ...
            $(document).ready(function() {
                ...
                $("#section").change(function() {
                    $("#pricelist").slideUp(function() {
                        ...
                        if (sectionname != "") {
                            $.post("productlist.do", {"sectionid":sectionname}, function (data) {
    ...
    <center>
        ...
        <p><b>Sección:</b> 
            <select id="section" size="1" class="ui-widget">
                ...
                <logic:iterate name="section_list" id="each" type="org.magmax.master.project.ui.shop.SectionForm">
                    <option value="<bean:write name="each" property="id"/>"><bean:write name="each" property="name"/></option>
                </logic:iterate>
            </select>
        </p>
